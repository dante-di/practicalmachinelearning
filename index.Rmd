...
The accuracy is very high (`r round(confusionMatrix(myTesting$classe, preds)[[3]][[1]]*100,1)`%) then we will use the "Random Forest model" to predict on the test set.
...
Subsequently we trained a model using the Random Forest Algorithm achieving a precision of 99.7%.
